    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-ivory flex flex-col items-center justify-center px-8 text-center">
          ...
          <p className="font-serif italic text-lg text-ink/60 mb-2">{WEDDING_DATE_DISPLAY}</p>
          <p className="font-serif italic text-sm text-ink/40 mb-8">Gedung Wanita Candra Kencana, Surabaya</p>
