...
const CoupleSection = lazy(() =>
  import("../components/sections/CoupleSection").then((m) => ({
    default: m.CoupleSection,
  })),
);
  ...
  useEffect(() => {
    ...
    if (to) {
      try {
        ...
        /* malformed URI — keep default guest name */
      }
    } else {
