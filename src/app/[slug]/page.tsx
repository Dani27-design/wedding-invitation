...
export async function generateMetadata({
  ...
  return {
    ...
    description,
    keywords: [
      `undangan pernikahan ${wedding.groomNickname} & ${wedding.brideNickname}`,
      `undangan pernikahan ${wedding.groomNickname}`,
      `undangan pernikahan ${wedding.brideNickname}`,
      `${wedding.groomName} & ${wedding.brideName}`,
      `${wedding.groomName}`,
      `${wedding.brideName}`,
      `pernikahan ${wedding.groomNickname} & ${wedding.brideNickname}`,
      `pernikahan ${wedding.groomName} & ${wedding.brideName}`,
      `wedding ${wedding.groomNickname} & ${wedding.brideNickname}`,
